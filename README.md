...
| **Attachments**      | `file-input-field`                             | Integrated file upload element (images, PDFs, documents)                |
...
1. **Hostel Maintenance Grievance**:
   ...
   - `issueDetails` (Textarea, required)
...
_Note: Testcontainers requires Docker Desktop to be running to start a temporary `mongo:7` container._
