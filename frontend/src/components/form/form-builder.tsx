        ...
        <div className="flex flex-col">
          <div className="flex items-center">
            <span className="font-medium">
              {field.elementType === "field" ? field.name : field.viewType}
            </span>
          ...
          <div className="mt-1">
            ...
            >
              {field.elementType === "field" ? field.fieldType : field.viewType}
            </span>
          </div>
        </div>
      </div>
                ...
                <div>
                  {(() => {
                    ...
                    if (
                      ...
                      selectedElement.fieldType === "text-field"
                    ) {
                      return (
                        <TextFieldOptions
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "text-area"
                    ) {
                      return (
                        <TextAreaOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "number-field"
                    ) {
                      return (
                        <NumberFieldOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "select-field"
                    ) {
                      return (
                        <SelectFieldOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "radio-field"
                    ) {
                      return (
                        <RadioFieldOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "checkbox-field"
                    ) {
                      return (
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "date-field"
                    ) {
                      return (
                        <DateFieldOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "time-field"
                    ) {
                      return (
                        <TimeFieldOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      selectedElement.fieldType === "date-time-field"
                    ) {
                      return (
                    ...
                    if (
                      selectedElement.elementType === "field" &&
                      (selectedElement.fieldType === "file-input-field" ||
                    ...
                    if (
                      selectedElement.elementType === "view" &&
                      selectedElement.viewType === "heading"
                    ) {
                      return (
                        <HeadingOptions
                          key={selectedElement.id}
                    ...
                    if (
                      selectedElement.elementType === "view" &&
                      selectedElement.viewType === "paragraph"
                    ) {
                      return (
                        <ParagraphOptions
                          key={selectedElement.id}
                    ...
                    return (
                      <p className="text-sm text-muted-foreground">
                        Options for this element are not yet implemented.
                      </p>
                    );
                  })()}
                </div>
                ...
                <div className="p-3 space-y-4">
                  <section>
                    ...
                    <div className="grid gap-1">
                      {formElements
                        .filter((e) => e.elementType === "view")
                        .map((e) => (
                          <Button
                            key={e.name}
                            variant="outline"
                            onClick={() => addElement(e)}
                            className="justify-start gap-2 text-[11px] h-8 px-2"
                          >
                            <FieldIcon name={e.icon} />
